...
import { registerDepRadarTools } from '../tools/depRadar.js';
...
export function createServer() {
    const server = new McpServer({ name: 'gitty', version: '2.0.0' });
    ...
    registerDepRadarTools(server); // check_license_and_dependencies
